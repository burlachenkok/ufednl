...
#=======================================================================================================
fname = os.path.join(os.getenv('HOME'), "test/fednl_impl/dopt/datasets/w8a")
#=======================================================================================================
...
if __name__ == "__main__":
  ...
  data = execute("LOAD DATA", load_svmlight_file, fname, zero_based = False)
  ...
  for solver in ["saga"]:
      ...
      fValue = evaluateLogisticObjective(designMat, labels, l2reg, xSolution)
      print("Optimal value f*: ", fValue)

      g = evaluateLogisticGradient(designMat, labels, l2reg, xSolution)
