...
// Callbacks
#include "TrainCallbaksSharedClientPP.h"
...
inline TrainReturnCodes train(const dopt::CmdLine& cmdline, ResultCallbackClientPP resultCallback)
{
    ...
    serverContext.clientPerRound = 0;
    serverContext.selectedClients = nullptr;

    //serverContext.serverConnection = serverConnectionSockets[kControl];
    //====================================================================================================================
