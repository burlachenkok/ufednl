...
/* CRC-32 Lookup Table for CRC-POLYNOMIAL EDB88320 (CRC-32-IEEE 802.3)*/
...
namespace dopt
{
    uint32_t crc32(const void* buffer, size_t size, uint32_t crc)
    {
        uint32_t k;

        for (size_t i = 0; i < size; i++)
        {
            k = (crc ^ ((unsigned char*)buffer)[i]) & 0x000000FFL;
