...
{
    template <>
    inline VectorNDStd<double>  VectorNDStd<double>::operator + (const VectorNDStd<double>& rhs) const
    {
        ...
        VectorNDStd<TElementType> res(sz);
    ...
    template <>
    inline VectorNDStd<double>  VectorNDStd<double>::scaledDifferenceWithEye(double a, const VectorNDStd<double>& rhs, double multiplier)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<double>&  VectorNDStd<double>::setAll(double value)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        // constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<double>&  VectorNDStd<double>::setAllToDefault()
    {
        size_t lenInBytes = sizeInBytes();
        double* restrict_ext rawItems = data();
    ...
    template <>
    inline double VectorNDStd<double>::operator & (const VectorNDStd<double>&rhs) const
    {
    ...
    template <>
    inline double VectorNDStd<double>::reducedDotProduct(const VectorNDStd<double>& a,
                                                         const VectorNDStd<double>& b,
                                                         size_t start,
                                                         size_t sz)
    {
        assert(start < a.size());
    ...
    template <>
    inline VectorNDStd<double> VectorNDStd<double>::operator - () const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<double>& VectorNDStd<double>::operator += (const VectorNDStd<double>& v)
    {
        assert(size() == v.size());
    ...
    template <>
    inline void VectorNDStd<double>::addInPlaceVectorWithMultiple(double multiple, const VectorNDStd<double>& other)
    {
    ...
    template <>
    inline void VectorNDStd<double>::subInPlaceVectorWithMultiple(double multiple, const VectorNDStd<double>& other)
    {
        assert(size() == other.size());
    ...
    template <>
    inline double VectorNDStd<double>::vectorL2NormSquare() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<double>& VectorNDStd<double>::operator *= (double factor)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<double> VectorNDStd<double>::operator * (double factor) const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
        ...
        size_t sz = size();
        VectorNDStd<TElementType> resVector(sz);
    ...
    template<>
    inline VectorNDStd<double> VectorNDStd<double>::exp() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<double> VectorNDStd<double>::square()
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<double> VectorNDStd<double>::log()
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<double> VectorNDStd<double>::concat(const VectorNDStd<double>& a, const VectorNDStd<double>& b)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
        ...
        VectorNDStd<TElementType> res(ab_size);
    ...
    template <>
    inline double VectorNDStd<double>::maxItem() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline double VectorNDStd<double>::minItem() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    inline TAccumulator VectorNDStd<double>::sum() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    template <class TAccumulator>
    inline TAccumulator VectorNDStd<double>::logisticUnweightedLossFromMargin(const VectorNDStd& margin)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    template <class TAccumulator>
    inline TAccumulator VectorNDStd<double>::logisticUnweightedLossFromMarginSigmoid(const VectorNDStd& classificationMarginSigmoid)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<double> VectorNDStd<double>::abs() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<double> VectorNDStd<double>::elementwiseSigmoid() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline void VectorNDStd<double>::computeDiffAndComputeL2Norm(const VectorNDStd<double>& rhs, double& restrict_ext l2NormOfDifference)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
