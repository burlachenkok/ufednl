...
{
    template <>
    inline VectorNDStd<float>  VectorNDStd<float>::operator + (const VectorNDStd<float>& rhs) const
    {
    ...
    template <>
    inline VectorNDStd<float>  VectorNDStd<float>::scaledDifferenceWithEye(float a, const VectorNDStd<float>& rhs, float multiplier)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<float>&  VectorNDStd<float>::setAll(float value)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        // constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<float>& VectorNDStd<float>::setAllToDefault()
    {
    ...
    template <>
    inline float  VectorNDStd<float>::operator & (const  VectorNDStd<float>&rhs) const
    {
    ...
    template <>
    inline float VectorNDStd<float>::reducedDotProduct(const VectorNDStd<float>& a,
                                                         const VectorNDStd<float>& b,
                                                         size_t start,
                                                         size_t sz)
    {
        assert(start < a.size());
    ...
    template <>
    inline VectorNDStd<float> VectorNDStd<float>::operator - () const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<float>& VectorNDStd<float>::operator += (const VectorNDStd<float>& v)
    {
        assert(size() == v.size());
    ...
    template <>
    inline void VectorNDStd<float>::addInPlaceVectorWithMultiple(float multiple, const VectorNDStd<float>& other)
    {
    ...
    template <>
    inline void VectorNDStd<float>::subInPlaceVectorWithMultiple(float multiple, const VectorNDStd<float>& other)
    {
        assert(size() == other.size());
    ...
    template <>
    inline float VectorNDStd<float>::vectorL2NormSquare() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<float>& VectorNDStd<float>::operator *= (double factor)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<float> VectorNDStd<float>::operator * (double factor) const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<float> VectorNDStd<float>::exp() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<float> VectorNDStd<float>::square()
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template<>
    inline VectorNDStd<float> VectorNDStd<float>::log()
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<float> VectorNDStd<float>::concat(const VectorNDStd<float>& a, const VectorNDStd<float>& b)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline float VectorNDStd<float>::maxItem() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline float VectorNDStd<float>::minItem() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    inline TAccumulator VectorNDStd<float>::sum() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    template <class TAccumulator>
    inline TAccumulator VectorNDStd<float>::logisticUnweightedLossFromMargin(const VectorNDStd& margin)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    template <class TAccumulator>
    inline TAccumulator VectorNDStd<float>::logisticUnweightedLossFromMarginSigmoid(const VectorNDStd<float>& classificationMarginSigmoid)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<float> VectorNDStd<float>::abs() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline VectorNDStd<float> VectorNDStd<float>::elementwiseSigmoid() const
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
    ...
    template <>
    inline void VectorNDStd<float>::computeDiffAndComputeL2Norm(const VectorNDStd<float>& rhs, float& restrict_ext l2NormOfDifference)
    {
        typedef dopt::VectorSimdTraits<TElementType, cpu_extension>::VecType VecType;
        constexpr size_t kVecBatchSize = dopt::getVecBatchSize<VecType>();
        constexpr size_t kUnrollFactor = dopt::getUnrollFactor<VecType>();
