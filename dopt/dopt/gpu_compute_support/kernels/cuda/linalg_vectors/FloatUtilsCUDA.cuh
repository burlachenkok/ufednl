...
namespace cuda4dopt
{
    ...
    */
    template <bool isArchLitteEndian, class T>
    KR_DEV_FN inline FPComponentsPack<isArchLitteEndian, T> getFloatPointMask2RemoveMantissa() {
    ...
    */
    template <bool isArchLitteEndian, class T>
    KR_DEV_FN inline FPComponentsPack<isArchLitteEndian, T> getFloatPointPack(T value) {
        FPComponentsPack<isArchLitteEndian, T> pack;
    ...
    */
    template <bool isArchLitteEndian, class T>
    KR_DEV_FN inline double getMantissaPartNoLeadingOne(FPComponentsPack<isArchLitteEndian, T> pack) {
    ...
    */
    ...
    KR_DEV_FN inline double getMantissaPartAndLeadingOne(FPComponentsPack<isArchLitteEndian, T> pack) {
        double value = double(pack.components.mantissa);
        value *= FPComponentsPack<isArchLitteEndian, T>::one_div_2_bits_mantissa;
        return 1.0 + value;
    }
    ...
    */    
    template <bool isArchLitteEndian>
    KR_DEV_FN inline uint32_t pack2FP64NoMantissa(cuda4dopt::FPComponentsPack<isArchLitteEndian, double> itemA,
                                                  cuda4dopt::FPComponentsPack<isArchLitteEndian, double> itemB)
    {
        constexpr size_t sign_a_shift = cuda4dopt::FPComponentsPack<isArchLitteEndian, double>::bits_exponent + cuda4dopt::FPComponentsPack<isArchLitteEndian, double>::bits_exponent + cuda4dopt::FPComponentsPack<isArchLitteEndian, double>::bits_sign;
        constexpr size_t mant_a_shift = cuda4dopt::FPComponentsPack<isArchLitteEndian, double>::bits_exponent + cuda4dopt::FPComponentsPack<isArchLitteEndian, double>::bits_sign;
        constexpr size_t sign_b_shift = cuda4dopt::FPComponentsPack<isArchLitteEndian, double>::bits_exponent;
    ...
    */
    template <bool isArchLitteEndian>
    KR_DEV_FN inline void unpack2FP64NoMantissa(FPComponentsPack<isArchLitteEndian, double> unpack[2], uint32_t buffer)
    {
