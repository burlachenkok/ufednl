...
FEDNL with LS:
  --line_search --c_line_search 0.49 --gamma_line_search 0.5 --algorithm fednl1 --k_compressor_as_d_mult 35 --compressor randk --train --train_dataset C:\projects\new\fednl_impl\dopt\datasets\phishing --add_intercept --reshuffle_train --clients 10 --lambda 0.001 --rounds 20 --tracking --global_lr 0.01 --theoretical_alpha --use_theoretical_alpha_option_1 --fednl-option-b --out result.bin
