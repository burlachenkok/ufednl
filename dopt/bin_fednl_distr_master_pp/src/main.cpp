/** Command line:
FEDNL:
--algorithm fednl1 --k_compressor_as_d_mult 35.5 --compressor randk --train --train_dataset C:\projects\new\fednl_impl\dopt\datasets\a1a --add_intercept --reshuffle_train --clients 10 clients-per-round 1 --lambda 0.001 --rounds 20 --silent --tracking --global_lr 0.01 --theoretical_alpha --use_theoretical_alpha_option_1 --fednl-option-b --out result.bin --master tcpv4:localhost:1212 --iam server
--algorithm fednl1 --k_compressor_as_d_mult 35.5 --compressor randk --train --client_train_dataset C:\projects\new\fednl_impl\dopt\datasets\a1a --add_intercept --reshuffle_train --clients 10 --clients-per-round 1 --lambda 0.001 --rounds 20 --silent --tracking --global_lr 0.01 --theoretical_alpha --use_theoretical_alpha_option_1 --fednl-option-b --out result.bin --master tcpv4:localhost:1212 --iam client:1

GD:
--algorithm gd --k_compressor_as_d_mult 35.5 --compressor randk --train --train_dataset C:\projects\new\fednl_impl\dopt\datasets\phishing --add_intercept --reshuffle_train --clients 10 --clients-per-round 1 --lambda 0.001 --rounds 20 --silent --tracking --global_lr 0.01 --theoretical_alpha --use_theoretical_alpha_option_1 --fednl-option-b --out result.bin
